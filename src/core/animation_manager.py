...
class AnimationManager:
    ...
    def update_frame(self):
        ...
        if self.current_state == "idle":
            ...
            # Покачивание и подпрыгивание при игре/поглаживании
            angle = 6 * math.sin(self.frame_counter * 0.6)
            bounce = -abs(8 * math.sin(self.frame_counter * 0.4))
            painter.rotate(angle)
            painter.translate(0, bounce)
        elif self.current_state == "shaking":
            # Сильное встряхивание с динамическим масштабом
