...
class PetWindow(QMainWindow):
    ...
    def __init__(self, config_manager=None):
        ...
        self.original_size = QSize(pet_size_val, pet_size_val)
    ...
    def set_pet_size(self, size_val):
        """Устанавливает базовый размер питомца и изменяет размер окна"""
        if self.config:
            self.config.set("pet_size", size_val)
